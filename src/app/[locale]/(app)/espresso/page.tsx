 ...
 * Phase 4 — Espresso hub + dial-in assistant
 */
export default async function Page() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 md:px-6">
      <h1 className="mb-6 text-2xl font-semibold text-[var(--color-espresso)]">{t("nav.espresso")}</h1>
      <EmptyState title={t("nav.espresso")} hint="Phase 4 — Espresso hub + dial-in assistant" />
    </div>
  );
}
