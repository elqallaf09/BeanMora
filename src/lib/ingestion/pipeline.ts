...
import { fetchSource, MissingCredentialsError, BlockedSourceError, type FetchedItem } from "./fetchers";
import { SOURCE_REGISTRY, isConfigured, type SourceDefinition } from "./sources";
...
import { exactSimilarity, tokenSimilarity } from "@/lib/duplicate-detection";
