...
/**
 * Shared comment composer for both community posts and recipes — `comments`
 * has mutually exclusive post_id/recipe_id columns (see migration 08's
 * comments_single_parent check), so this accepts either target and inserts
 * against whichever one is set. Mirrors community/[id]/comment-box.tsx.
 */
